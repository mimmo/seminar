...
import seminar.queue.decorator.MonitorableQueue;
import seminar.queue.decorator.SimpleQueue;

public class MonitorableDecoratorTest {
	MonitorableQueue _queue;

	@Before
	public void setUp() {
		_queue = new MonitorableQueue(new SimpleQueue(10));
	}
